...
export class RegisterClientComponent {
  ...
  submit(): void {
    ...
    this.auth.registerClient({ full_name: full_name!, email: email!, phone: normalizeChileanPhoneForBackend(phone ?? ''), password: password!, terms_accepted: !!terms_accepted }).subscribe({
      next: () => {
