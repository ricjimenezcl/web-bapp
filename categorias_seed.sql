...
-- Eliminar en orden correcto (services y subcategories, NO main_categories)
DROP TABLE IF EXISTS services CASCADE;
DROP TABLE IF EXISTS subcategories CASCADE;

-- main_categories ya existe: IF NOT EXISTS la salta sin error
...
-- Garantizar columna is_active si la tabla fue recreada sin ella
ALTER TABLE main_categories ADD COLUMN IF NOT EXISTS is_active BOOLEAN DEFAULT TRUE;
...
INSERT INTO main_categories (id, name, description, icon)
VALUES (1, 'Hogar y Construcción', 'Obras, gasfitería, electricidad, pintura, carpintería, seguridad, aseo del hogar, jardinería, control de plagas y reparación de electrodomésticos.', 'hammer-outline')
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, description = EXCLUDED.description, icon = EXCLUDED.icon;

INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (1, 'Obras y estructura', 'construct-outline', 1);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (2, 'Carpintería y vidriería', 'cut-outline', 1);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (3, 'Instalaciones', 'water-outline', 1);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (4, 'Seguridad', 'shield-outline', 1);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (5, 'Pintura', 'brush-outline', 1);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (6, 'Equipamiento y decoración', 'home-outline', 1);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (7, 'Aseo y limpieza', 'sparkles-outline', 1);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (8, 'Jardinería y exterior', 'leaf-outline', 1);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (9, 'Control de plagas', 'bug-outline', 1);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (10, 'Organización y cocina', 'restaurant-outline', 1);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (11, 'Reparaciones', 'build-outline', 1);
...
-- ── Belleza y Bienestar ──
INSERT INTO main_categories (id, name, description, icon)
VALUES (2, 'Belleza y Bienestar', 'Peluquería, manicure, depilación, maquillaje, tratamientos faciales y corporales, masajes, tatuajes, piercings y micropigmentación.', 'flower-outline')
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, description = EXCLUDED.description, icon = EXCLUDED.icon;

INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (12, 'Cabello', 'cut-outline', 2);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (13, 'Uñas', 'finger-print-outline', 2);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (14, 'Depilación y cejas', 'eye-outline', 2);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (15, 'Maquillaje', 'brush-outline', 2);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (16, 'Tratamientos', 'bandage-outline', 2);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (17, 'Masajes', 'body-outline', 2);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (18, 'Tatuajes', 'pencil-outline', 2);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (19, 'Piercings', 'radio-button-off-outline', 2);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (20, 'Micropigmentación', 'create-outline', 2);
...
-- ── Cuidado y Salud ──
INSERT INTO main_categories (id, name, description, icon)
VALUES (3, 'Cuidado y Salud', 'Enfermería y salud a domicilio, kinesioterapia, psicología, cuidado de niños, acompañamiento de adultos mayores y servicios para mascotas.', 'medkit-outline')
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, description = EXCLUDED.description, icon = EXCLUDED.icon;

INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (21, 'Salud en casa', 'medkit-outline', 3);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (22, 'Terapias y rehabilitación', 'fitness-outline', 3);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (23, 'Salud mental y nutrición', 'heart-outline', 3);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (24, 'Niños y niñera', 'happy-outline', 3);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (25, 'Estimulación y educación infantil', 'school-outline', 3);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (26, 'Adultos mayores', 'people-outline', 3);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (27, 'Mascotas', 'paw-outline', 3);
...
-- ── Educación y Deporte ──
INSERT INTO main_categories (id, name, description, icon)
VALUES (4, 'Educación y Deporte', 'Reforzamiento escolar, clases de idiomas, música, arte, entrenamiento personal, artes marciales, deportes de equipo, natación y baile.', 'school-outline')
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, description = EXCLUDED.description, icon = EXCLUDED.icon;

INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (28, 'Reforzamiento escolar', 'book-outline', 4);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (29, 'Tecnología', 'laptop-outline', 4);
INSERT INTO services (id, name, subcategory_id) VALUES (147, 'Clases de computación', 29);

INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (30, 'Música', 'musical-notes-outline', 4);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (31, 'Idiomas', 'globe-outline', 4);
INSERT INTO services (id, name, subcategory_id) VALUES (151, 'Clases de idiomas (francés, portugués, mandarín)', 31);

INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (32, 'Arte', 'color-palette-outline', 4);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (33, 'Entrenamiento personal', 'barbell-outline', 4);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (34, 'Deportes de raqueta', 'tennisball-outline', 4);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (35, 'Deportes de equipo', 'football-outline', 4);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (36, 'Artes marciales y contacto', 'flash-outline', 4);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (37, 'Baile y bienestar', 'musical-note-outline', 4);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (38, 'Natación', 'water-outline', 4);
INSERT INTO services (id, name, subcategory_id) VALUES (168, 'Clases de natación', 38);

INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (39, 'Eventos deportivos', 'trophy-outline', 4);
INSERT INTO services (id, name, subcategory_id) VALUES (169, 'Recreación y eventos deportivos', 39);

-- ── Tecnología y Vehículos ──
INSERT INTO main_categories (id, name, description, icon)
VALUES (5, 'Tecnología y Vehículos', 'Mecánica automotriz y de motos, electricidad vehicular, reparación de celulares, computadores, soporte técnico y servicio a domicilio.', 'car-outline')
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, description = EXCLUDED.description, icon = EXCLUDED.icon;

INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (40, 'Mecánica general', 'car-sport-outline', 5);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (41, 'Motos', 'bicycle-outline', 5);
INSERT INTO services (id, name, subcategory_id) VALUES (178, 'Mecánica de motos', 41);

INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (42, 'Electricidad y electrónica automotriz', 'flash-outline', 5);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (43, 'Carrocería y estética', 'color-fill-outline', 5);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (44, 'Neumáticos y dirección', 'settings-outline', 5);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (45, 'Servicios automotrices especiales', 'build-outline', 5);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (46, 'Celulares y tablets', 'phone-portrait-outline', 5);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (47, 'Computadores y notebooks', 'laptop-outline', 5);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (48, 'Servicio y soporte técnico', 'help-circle-outline', 5);
...
-- ── Alimentación ──
INSERT INTO main_categories (id, name, description, icon)
VALUES (6, 'Alimentación', 'Delivery de comida casera y especialidades, panadería, catering, banquetería, cocineros por horas y opciones veganas o vegetarianas.', 'restaurant-outline')
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, description = EXCLUDED.description, icon = EXCLUDED.icon;

INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (49, 'Delivery a domicilio', 'bicycle-outline', 6);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (50, 'Platos y especialidades', 'restaurant-outline', 6);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (51, 'Panadería y dulces', 'cafe-outline', 6);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (52, 'Catering y servicios', 'wine-outline', 6);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (53, 'Opciones especiales', 'leaf-outline', 6);
INSERT INTO services (id, name, subcategory_id) VALUES (218, 'Comida rápida vegana/vegetariana', 53);

-- ── Eventos y Traslados ──
INSERT INTO main_categories (id, name, description, icon)
VALUES (7, 'Eventos y Traslados', 'DJ, animación infantil, fotografía, decoración y logística de eventos, mudanzas, fletes, choferes, traslados especiales y mensajería.', 'musical-notes-outline')
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, description = EXCLUDED.description, icon = EXCLUDED.icon;

INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (54, 'Música y DJ', 'musical-notes-outline', 7);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (55, 'Animación infantil', 'happy-outline', 7);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (56, 'Fotografía y video', 'camera-outline', 7);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (57, 'Ceremonias', 'ribbon-outline', 7);
INSERT INTO services (id, name, subcategory_id) VALUES (231, 'Maestro de ceremonias', 57);

INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (58, 'Decoración y logística', 'star-outline', 7);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (59, 'Mudanzas y fletes', 'cube-outline', 7);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (60, 'Choferes', 'car-outline', 7);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (61, 'Traslados especiales', 'airplane-outline', 7);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (62, 'Mensajería', 'send-outline', 7);
INSERT INTO services (id, name, subcategory_id) VALUES (243, 'Mensajería y delivery', 62);

INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (63, 'Vans y colectivos', 'bus-outline', 7);
INSERT INTO services (id, name, subcategory_id) VALUES (244, 'Servicio de minivan', 63);

-- ── Arte y Creatividad ──
INSERT INTO main_categories (id, name, description, icon)
VALUES (8, 'Arte y Creatividad', 'Joyería artesanal, cerámica, tejidos y bordados, confección de ropa, arte visual, lectura de cartas, sanación energética y terapias complementarias.', 'color-palette-outline')
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, description = EXCLUDED.description, icon = EXCLUDED.icon;

INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (64, 'Joyería', 'diamond-outline', 8);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (65, 'Cerámica', 'flask-outline', 8);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (66, 'Tejidos y bordados artesanales', 'grid-outline', 8);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (67, 'Arte visual', 'image-outline', 8);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (68, 'Confección de ropa', 'shirt-outline', 8);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (69, 'Arriendo y textiles', 'bag-outline', 8);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (70, 'Bordados y estampados', 'color-wand-outline', 8);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (71, 'Lectura y predicción', 'book-outline', 8);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (72, 'Energía y sanación', 'planet-outline', 8);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (73, 'Rituales y protección', 'shield-checkmark-outline', 8);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (74, 'Consejería y meditación', 'chatbubble-ellipses-outline', 8);
...
INSERT INTO subcategories (id, name, icon, main_category_id) VALUES (75, 'Terapias complementarias', 'leaf-outline', 8);
...
-- ------------------------------------------------------------
-- SYNC service_categories (compatibilidad FK con service_providers)
-- Inserta en service_categories los servicios del nuevo catálogo
-- que aún no existen por nombre (case-insensitive).
-- Esto garantiza que el JOIN por nombre en la API retorne
-- service_category_id no-NULL para todos los servicios.
-- ------------------------------------------------------------
INSERT INTO service_categories (name, main_category_id, is_active)
SELECT DISTINCT s.name, sub.main_category_id, true
FROM services s
JOIN subcategories sub ON sub.id = s.subcategory_id
WHERE NOT EXISTS (
    SELECT 1 FROM service_categories sc
    WHERE LOWER(TRIM(sc.name)) = LOWER(TRIM(s.name))
);
