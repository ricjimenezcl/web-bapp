      ...
      @if (loading()) {
        ...
        <form [formGroup]="form" (ngSubmit)="submit()" class="p-4 space-y-4">
          @if (success()) {
            <div class="alert alert-success rounded-2xl border border-success-200 bg-success-50 text-success-900 shadow-sm" role="status">
              <div class="flex items-center gap-3">
                ...
                <div>
                  <p class="font-semibold">Servicio actualizado exitosamente</p>
                  <p class="text-sm text-success-700">Los cambios se guardaron correctamente en tu servicio.</p>
                </div>
              </div>
            </div>
          }
          @if (error()) {
            <div class="alert alert-danger rounded-2xl border border-danger-200 bg-danger-50 text-danger-900 shadow-sm" role="alert">
              <div class="flex items-center gap-3">
                ...
                <div>
                  <p class="font-semibold">Error al actualizar el servicio</p>
          ...
          <div class="grid grid-cols-2 gap-3">
            <button type="button" class="btn btn-secondary btn-block btn-lg" (click)="cancel()" [disabled]="saving()">
              Cancelar
            </button>
